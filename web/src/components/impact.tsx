  ...
  return (
    <section aria-label="Impact by the numbers" className="relative border-t border-line py-16">
      ...
      <motion.div
        ...
        variants={container}
        className="mx-auto grid max-w-page grid-cols-2 gap-4 px-gutter sm:grid-cols-3 md:grid-cols-6"
      >
        {STATS.map(({ value, label, tag, Icon }) => (
          <motion.div
            ...
            className="group relative overflow-hidden rounded-brand border border-line bg-bg-elev p-5 shadow-brand"
          >
            <Icon
              aria-hidden="true"
              className="pointer-events-none absolute -bottom-3 -right-3 h-20 w-20 text-ink opacity-[0.06] transition-transform duration-500 group-hover:scale-110"
            />
            ...
            <p className="relative mt-4 font-mono text-3xl font-bold text-ink">
              {value}
            </p>
